...
public class UHFBaseActivity extends BaseActivity {
	...
	// static int _PingPong_ReadTime = 10000; // The default is 100:3
	// static int _PingPong_StopTime = 300;
	static int _NowAntennaNo = 1; // Antenna No.
	static int _UpDataTime = 0; // Repeat tag upload time, control tag upload speed not too fast
	static int _Max_Power = 30; // Maximum transmitting power of the reader
	static int _Min_Power = 0; // Minimum transmitting power of the reader
