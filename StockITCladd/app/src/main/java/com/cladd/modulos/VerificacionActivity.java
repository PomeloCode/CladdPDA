...
public class VerificacionActivity extends UHFBaseActivity implements
	...
	protected void ConfigureRFIDModule() {
		...
		try {
			...
			PDASettings pda = FillPDASettings(GetPDAConfigDB(getString(R.string.Verificacion)),getString(R.string.Verificacion));
	...
	protected void InitDBConexion() {
		...
		dataBaseHelper = new DataBaseHelper(VerificacionActivity.this);
