...
public interface ApiInterface {
    ...
    Call<JsonElement> getDynamicConfigs();

    /************************************ Ver Detalle **************************************************/

    @POST("Api/IntegrationStockIT/ConsultaStock")
    Call<JsonElement> ConsultarPieza(@Body RequestBody map);
    ...
    Call<JsonElement> GrabarEtiquetaStockInicial(@Body RequestBody map);

    @POST("Api/IntegrationStockIT/GrabarEtiquetaSinUbicarStockInicial")
    Call<JsonElement> GrabarEtiquetaSinUbicarStockInicial(@Body RequestBody map);
    ...
    Call<ResponseBody> GrabarEtiquetaContenedor(@Query("ContainerID") String containerID);
