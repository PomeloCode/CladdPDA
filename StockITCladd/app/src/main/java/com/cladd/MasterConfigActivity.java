...
public class MasterConfigActivity extends UHFBaseActivity implements
	...
	private TextView tv_sdkVersion = null;
	...
	protected void Init() {
		...
		if (!UHF_Init(this)) { // Failed to power on the module
			showMsg(getString(R.string.uhf_low_power_info),
					new OnClickListener() {
						...
						public void onClick(DialogInterface arg0, int arg1) {
							MasterConfigActivity.this.finish();
						}
					});
		} else {
			...
			tv_sdkVersion = (TextView) this.findViewById(R.id.tv_sdkVersion);
			...
			tv_sdkVersion.setText(Adapt.getVersion());
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		BindToolBar();
		SetToolBar(
				getString(R.string.MasterConfig),
